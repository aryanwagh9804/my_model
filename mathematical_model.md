...
$$A_u = \begin{cases} 1 & \text{if } F_{\text{detect}}(f_t) \land F_{\text{liveness}}(f_t) \land \left(F_{\text{recognize}}(f_t)=u\right) \land \neg F_{\text{antispoof}}(f_t) \\\\ 0 & \text{otherwise} \end{cases}$$
